# Dashboard Plugin v2.12.0

Dashboard Plugin v2.12.0 is a standalone WordPress shortcode plugin for creating multiple live dashboard metrics from published Google Sheets.
...
3. Upload the stable update package for the v2.12.0 release.
...
Download: `https://github.com/andyhayes74-commits/dashboard-plugin/raw/refs/heads/v2.12.0/dashboard-plugin-main-v2.12.0.zip`
